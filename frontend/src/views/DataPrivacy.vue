<template>
  <v-container>
    ...
    <p class="text-body-1">
      ...
      Mensa Today. The use of the Internet pages of the Mensa Today is possible
    ...
    <p>
      ...
      the country-specific data protection regulations applicable to the Mensa
      Today. By means of this data protection declaration, our enterprise would
    ...
    <p>
      As the controller, the Mensa Today has implemented numerous technical and
    ...
    <p>
      The data protection declaration of the Mensa Today is based on the terms
    ...
    <ul style="list-style: none">
      <li>
        <div class="text-h6">a) Personal data</div>
        <p>
      ...
      <li>
        <div class="text-h6">b) Data subject</div>
        <p>
      ...
      <li>
        <div class="text-h6">c) Processing</div>
        <p>
      ...
      <li>
        <div class="text-h6">d) Restriction of processing</div>
        <p>
      ...
      <li>
        <div class="text-h6">e) Profiling</div>
        <p>
      ...
      <li>
        <div class="text-h6">f) Pseudonymisation</div>
        <p>
      ...
      <li>
        <div class="text-h6">h) Processor</div>
        <p>
      ...
      <li>
        <div class="text-h6">i) Recipient</div>
        <p>
      ...
      <li>
        <div class="text-h6">j) Third party</div>
        <p>
      ...
      <li>
        <div class="text-h6">k) Consent</div>
        <p>
    ...
    <p>
      The Internet pages of the Mensa Today use cookies. Cookies are text files
    ...
    <p>
      Through the use of cookies, the Mensa Today can provide the users of this
    ...
    <p>
      The website of the Mensa Today collects a series of general data and
    ...
    <p>
      When using these general data and information, the Mensa Today does not
      ...
      Therefore, the Mensa Today analyzes anonymously collected data and
    ...
    <p>
      On the website of the Mensa Today, users are given the opportunity to
    ...
    <p>
      The Mensa Today informs its customers and business partners regularly by
    ...
    <p>
      The newsletter of the Mensa Today contains so-called tracking pixels. A
      ...
      campaigns. Based on the embedded tracking pixel, the Mensa Today may see
    ...
    <p>
      ...
      personal data will be deleted by the controller. The Mensa Today
    ...
    <ul style="list-style: none">
      <li>
        <div class="text-h6">a) Right of confirmation</div>
        <p>
      ...
      <li>
        <div class="text-h6">b) Right of access</div>
        <p>
          Each data subject shall have the right granted by the European
        ...
        <p>
          ...
          as to whether personal data are transferred to a third country or to
      ...
      <li>
        <div class="text-h6">c) Right to rectification</div>
        <p>
          Each data subject shall have the right granted by the European
      ...
      <li>
        ...
        <p>
          ...
          wishes to request the erasure of personal data stored by the Mensa
          Today, he or she may, at any time, contact any employee of the
          controller. An employee of Mensa Today shall promptly ensure that the
        ...
        <p>
          ...
          required. An employees of the Mensa Today will arrange the necessary
          measures in individual cases.
        </p>
      </li>
      <li>
        <div class="text-h6">e) Right of restriction of processing</div>
        <p>
          Each data subject shall have the right granted by the European
        ...
        <p>
          ...
          stored by the Mensa Today, he or she may at any time contact any
          employee of the controller. The employee of the Mensa Today will
          arrange the restriction of the processing.
        </p>
      </li>
      <li>
        <div class="text-h6">f) Right to data portability</div>
        <p>
          Each data subject shall have the right granted by the European
        ...
        <p>
          ...
          at any time contact any employee of the Mensa Today.
        </p>
      </li>
      <li>
        ...
        <p>
          The Mensa Today shall no longer process the personal data in the event
        ...
        <p>
          If the Mensa Today processes personal data for direct marketing
          ...
          to such direct marketing. If the data subject objects to the Mensa
          Today to the processing for direct marketing purposes, the Mensa Today
        ...
        <p>
          ...
          data concerning him or her by the Mensa Today for scientific or
        ...
        <p>
          ...
          any employee of the Mensa Today. In addition, the data subject is free
      ...
      <li>
        ...
        <p>
          ...
          it is based on the data subject's explicit consent, the Mensa Today
        ...
        <p>
          ...
          employee of the Mensa Today.
        </p>
      </li>
      <li>
        <div class="text-h6">i) Right to withdraw data protection consent</div>
        <p>
          Each data subject shall have the right granted by the European
        ...
        <p>
          ...
          consent, he or she may, at any time, contact any employee of the Mensa
          Today.
        </p>
      </li>
    </ul>
