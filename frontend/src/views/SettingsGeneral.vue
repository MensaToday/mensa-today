        ...
        v-card.mx-auto.my-12(width='800')
          v-list(style="background:transparent;")
            ...
            v-list-item.justify-end
              v-btn(color="primary" @click="updateObject(allergies, selected_allergies); updateObject(additives, selected_additives); updateSelectedCategories(); updateUserInfo(updatedInfo.mensa_card_id, selected_categories, selected_allergies);") Update Profile    
</template>
